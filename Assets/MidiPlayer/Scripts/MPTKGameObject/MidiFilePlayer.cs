...
namespace MidiPlayerTK
{
    ...
    public partial class MidiFilePlayer : MidiSynth
    {
        ...
        /// If you want to set the start position for playing a Midifile, set MPTK_TickCurrent inside an event OnEventStartPlayMidi because MPTK_Play() reset the start position to 0.
        /// </summary>
