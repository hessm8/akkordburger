...
namespace MidiPlayerTK
{
    ...
    /// <summary>
    /// Class for the Synthesizer. Contains all the function to load a SoundFont, process a MidiEvent, play voices associated to the Midi Event. 
    /// This class is inherited by others class: MidiStreamPlayer, MidiFilePlayer, MidiInReader, MidiStreamPlayer
    /// It is not recommended to instanciate directly this class, rather use the prefabs associated to the inherited class in your project.
    /// </summary>
#if MPTK_PRO && UNITY_ANDROID && UNITY_OBOE
